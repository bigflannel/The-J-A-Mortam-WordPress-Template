<?php
	...
	if (!function_exists('jam_theme_setup')) {
	...
	if (!function_exists('jam_slug_fonts_url')) { 
	...
	if (!function_exists('jam_script_enqueuer')) { 
	 ...
	 */
	 ...
	 if (!function_exists('jam_register_sidebar')) { 
	...
	if (!function_exists('jam_fullscreen_slideshow_data_new')) {
	...
	if (!function_exists('jam_search_form')) {
	...
	if (!function_exists('jam_excerpt_link')) {
	...
	if (!function_exists('jam_excerpt_protected')) {
	...
	if (!function_exists('jam_comment')) {
	...
	if (!function_exists('jam_validate_options')) {
	...
	if (!function_exists('jam_admin_theme_options')) {
	...
	if (!function_exists('jam_admin_options_page')) {
	...
	if (!function_exists('jam_admin_custom_header_fonts')) {
