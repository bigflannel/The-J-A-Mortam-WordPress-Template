			...
			<li class="group">
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					<?php if (get_the_title() == '') { ?>
						<div class="meta post-meta"><span class="post-date"><a href="<?php esc_url( the_permalink() ); ?>" rel="bookmark"><?php the_date(); ?></a> </span><span class="post-comments"><?php comments_popup_link(__('Leave a Comment','the-j-a-mortram'), __('1 Comment','the-j-a-mortram'), __('% Comments','the-j-a-mortram'), '', ''); ?></span>
						</div>
					<?php } else { ?>
